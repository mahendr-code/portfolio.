...
/* Hero */
gsap.from(".hero-tag", { y: 50, opacity: 0, duration: 1 });
gsap.from(".hero-content h1", { y: 80, opacity: 0, duration: 1.2, delay: 0.2 });
gsap.from(".hero-content p", { y: 50, opacity: 0, duration: 1, delay: 0.6 });
gsap.from(".hero-buttons", { y: 50, opacity: 0, duration: 1, delay: 0.8 });
gsap.from(".hero-avatar-wrap", { x: 100, opacity: 0, duration: 1.5, delay: 0.5 });
...
scrollReveal(".experience-item", ".experience-timeline", { stagger: 0.15 });
...
scrollReveal(".contact-form", ".contact-section", { y: 30 });
